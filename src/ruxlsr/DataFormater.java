...
public class DataFormater {
    ...
    private static void eventPrinter(JSONObject event) {
        ...
        switch (event.getString("type")) {
            case "PushEvent" -> {
                System.out.println(
                        createdAt + ":: Pushed " + eventPayLoad.getInt("distinct_size") + " commit(s) to " + repoName);
            }
            case "CreateEvent" -> {
                System.out
                        .println(createdAt + ":: created a " + eventPayLoad.getString("ref_type") + " to " + repoName);
            }
            ...
            case "DeleteEvent" -> {
                System.out
                        .println(createdAt + ":: deleted a " + eventPayLoad.getString("ref_type") + " to " + repoName);
            }
            case "ForkEvent" -> {
            ...
            case "GollumEvent" -> {
                ...
                System.out.println(createdAt + ":: " + page.getString("action") + " --" + page.getString("page_name")
                        + "-- wiki page to " + repoName);
            }
            case "IssueCommentEvent" -> {
                System.out.println(createdAt + ":: " + eventPayLoad.getString("action") + " a comment on the issues --"
                        + eventPayLoad.getJSONObject("issue").getString("title") + "-- on" + repoName);
            }
            case "IssuesEvent" -> {
                System.out.println(createdAt + ":: " + eventPayLoad.getString("action") + " the issue --"
                        + eventPayLoad.getJSONObject("issue").getString("title") + "-- on" + repoName);
            }
            case "MemberEvent" -> {
            ...
            case "PullRequestReviewEvent" -> {
                System.out.println(
                        createdAt + ":: " + eventPayLoad.getString("action") + " a pull request review on " + repoName);
            }
            ...
            case "PullRequestReviewThreadEvent" -> {
                System.out.println(
                        createdAt + ":: Mark a thread as " + eventPayLoad.getString("action") + " on " + repoName);
            }
            case "PullRequestEvent" -> {
                System.out.println(
                        createdAt + ":: " + eventPayLoad.getString("action") + " a pull request on" + repoName);
            }
            case "ReleaseEvent" -> {
            ...
            case "SponsorshipEvent" -> {
                System.out.println(
                        createdAt + ":: " + eventPayLoad.getString("action") + " Sponsorship action on " + repoName);
            }
